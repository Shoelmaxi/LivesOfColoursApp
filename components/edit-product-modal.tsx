...
export function EditProductModal({ visible, producto, onClose, onSave, onDelete }: EditProductModalProps) {
    ...
    <Modal visible={visible} animationType="slide" onRequestClose={handleClose}>
      <View
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          {/* Stock Actual */}
          <View style={styles.section}>
            <ThemedText type="defaultSemiBold">Stock Actual *</ThemedText>
            <TextInput
              style={[
                styles.input,
                {
          ...
          <View style={styles.section}>
            <TouchableOpacity style={styles.deleteButton} onPress={handleDelete}>
              <ThemedText style={styles.deleteButtonText}>🗑️ Eliminar Producto</ThemedText>
            </TouchableOpacity>
          </View>
        </ScrollView>
